...
const JWT_SECRET = Constants.expoConfig.extra.JWT_SECRET;
const MongoUser = Constants.expoConfig.extra.MongoUserName;
const MongoPass = Constants.expoConfig.extra.MongoPassword;
...
getMongoCredentials().then(({ MongoUser, MongoPass }) => {
